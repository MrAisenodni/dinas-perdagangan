        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo base_url('galeri/tambahvideo') ?>" class="btn btn-primary ">Tambah</a>
                </div>
            </div>
            <div class="box-body">
                    ...
                    <tbody>
                        <?php if (!empty($galerivideo)) :
                            foreach ($galerivideo as $key => $p) {
                                ...
                                echo '<td><video controls width="150px" ><source src="' . base_url('upload/' . $p->video) . '"  ></video> </td>';
                                echo '<td><a href="' . base_url('galeri/editvideo/' . $p->idvideo) . '"class="btn btn-info btn-xs">Edit</a>
                    <a href="' . base_url('galeri/hapusvideo/' . $p->idvideo) . '" class="btn btn-danger btn-xs">Hapus</a>              
                    </td>';
                                echo '</tr>';
                            }
                        endif; ?>
