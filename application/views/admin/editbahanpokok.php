    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Edit Bahan Pokok</h3>
            </div>
            <div class="box-body">
                <form data-parsley-validate action="<?php echo base_url('layanan/simpaneditbahanpokok') ?>" method="post" enctype="multipart/form-data">
                    <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <a class="btn btn-default" href="<?php echo base_url('daftarbahanpokok') ?>">Kembali</a>
                    </div>
