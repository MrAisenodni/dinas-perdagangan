        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo base_url('admin/tambahadmin') ?>" class="btn btn-primary ">Tambah</a>
                </div>
            </div>
            <div class="box-body">
                    ...
                    <tbody>
                        <?php if (!empty($admin)) :
                            foreach ($admin as $key => $p) {
                                ...
                                echo '<td><a href="' . base_url('admin/editadmin/' . $p->idadmin) . '"class="btn btn-info btn-xs">Edit</a>
                    <a href="' . base_url('admin/hapusadmin/' . $p->idadmin) . '" class="btn btn-danger btn-xs">Hapus</a>              
                    </td>';
                                echo '</tr>';
                            }
                        endif; ?>
